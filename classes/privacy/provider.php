...
/**
 * Privacy Subsystem implementation for paygw_tdb.
 *
 * @package    paygw_tdb
 * @category   privacy
    ...
    paygw_provider
{
    ...
    public static function get_metadata(collection $items): collection
    {
        $items->add_database_table(
            'paygw_tdb',
            [
                'userid'       => 'privacy:metadata:paygw_tdb:userid',
                'status'       => 'privacy:metadata:paygw_tdb:status',
                'timecreated'  => 'privacy:metadata:paygw_tdb:timecreated',
                'timemodified' => 'privacy:metadata:paygw_tdb:timemodified',
            ],
            'privacy:metadata:paygw_tdb'
        );
    ...
    public static function export_payment_data(\context $context, array $subcontext, \stdClass $payment)
    {
        ...
        $subcontext[] = get_string('gatewayname', 'paygw_tdb');
        $record = $DB->get_record('paygw_tdb', ['paymentid' => $payment->id]);
    ...
    public static function delete_data_for_payment_sql(string $paymentsql, array $paymentparams)
    {
        ...
        $DB->delete_records_select('paygw_tdb', "paymentid IN ({$paymentsql})", $paymentparams);
    }
